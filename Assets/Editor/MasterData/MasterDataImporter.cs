...
namespace Assets.Editor.MasterData
{
    public class MasterDataImporter
    {
        ...
        private const string MASTER_DATA_CONTAINER_FORMAT = "MasterData.{0},Assembly-CSharp";
        private const string MASTER_DATA_RECORD_FORMAT = "MasterData.{0}Record,Assembly-CSharp";
